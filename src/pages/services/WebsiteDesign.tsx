...
const WebsiteDesign = () => {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Our team consists of mid-level and senior web designers with 3+ years of expertise in your specific industry, ensuring your website is perfectly aligned with your audience's expectations.",
    },
    {
      icon: Heart,
  ...
  return (
    <>
      <SEOHead
        title="Website Design Services | Intrao Tech"
        description="Creating exciting websites that generate profit. We specialize in crafting websites that balance business needs with creativity."
