...
const Team = () => {
  ...
  return (
    <>
      <SEOHead
        title="Team and Advisors | Intrao Tech"
        description="Meet the talented team and advisors behind Intrao Tech. Our experts bring years of experience in design, development, and digital strategy."
        canonical="/team"
      />
