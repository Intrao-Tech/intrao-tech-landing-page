            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <p>
                    We are Intrao Tech ("Company," "we," "us," "our").
                  </p>
                  <p>
                ...
                {/* Section 5 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">5. Policy</h3>
                ...
                {/* Section 7 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">7. User Generated Contributions</h3>
                  <p>The Services does not offer users to submit or post content.</p>
                </div>

                {/* Section 8 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">8. Contribution License</h3>
                  <p>
                ...
                {/* Section 9 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">9. Guidelines for Reviews</h3>
                  <p>
                ...
                {/* Section 10 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">10. Services Management</h3>
                  <p>
                ...
                {/* Section 12 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">12. Term and Termination</h3>
                  <p>
                ...
                {/* Section 13 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">13. Modifications and Interruptions</h3>
                  <p>
                ...
                {/* Section 15 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">15. Dispute Resolution</h3>

                  <h4 className="font-semibold">Informal Negotiations</h4>
                  <p>
                    To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a "Dispute" and collectively, the "Disputes") brought by either you or us (individually, a "Party" and collectively, the "Parties"), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least one month before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.
                  </p>
                  ...
                  <h4 className="font-semibold mt-4">Exceptions to Informal Negotiations and Arbitration</h4>
                  <p>
                ...
                {/* Section 16 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">16. Corrections</h3>
                  <p>
                ...
                {/* Section 17 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">17. Disclaimer</h3>
                  <p>
                ...
                {/* Section 18 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">18. Limitations of Liability</h3>
                  <p>
                ...
                {/* Section 19 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">19. Indemnification</h3>
                  <p>
                ...
                {/* Section 20 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">20. User Data</h3>
                  <p>
                ...
                {/* Section 21 */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold uppercase">21. Electronic Communications, Transactions, and Signatures</h3>
                  <p>
