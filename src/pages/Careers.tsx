...
const Careers = () => {
  ...
  return (
    <>
      <SEOHead
        title="Careers | Intrao Tech - Join Our Team"
        description="Join Intrao Tech and be part of a team that's shaping the future of digital products. Explore our open positions and start your journey with us."
        canonical="/careers"
      />
