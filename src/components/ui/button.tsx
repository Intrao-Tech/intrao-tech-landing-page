  ...
  "inline-flex items-center justify-center gap-3 whitespace-nowrap rounded-lg text-base font-semibold uppercase tracking-wider ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "icon-dark": "bg-dark-foreground/10 text-dark-foreground rounded-lg hover:bg-dark-foreground/20",
        "icon-light": "bg-foreground/10 text-foreground rounded-lg hover:bg-foreground/20",
      },
      size: {
        ...
        "icon-md": "h-12 w-12 [&_svg]:size-5",
        "icon-lg": "h-16 w-16 [&_svg]:size-6",
      },
    },
    defaultVariants: {
      variant: "default",
