    ...
    <section className="bg-dark text-dark-foreground py-24 lg:py-32">
      <div className="container mx-auto px-6">
        ...
        >
          <Link
            to="/services"
            className="inline-flex items-center gap-2 border border-dark-muted text-dark-foreground px-8 py-4 text-sm font-semibold uppercase tracking-wider transition-all duration-300 hover:bg-dark-foreground hover:text-dark"
          >
